...
export function createCoreLifeConceptRegistryV0() {
  return new ConceptRegistry()
    ...
    .register({ id: "CREATIVE_PRACTICE", label: "creative practice", kind: "ACTIVITY", aliases: ["creative session"], parentIds: ["ACTIVITY"] })
    .register({ id: "MUSIC_PRODUCTION", label: "music production", kind: "ACTIVITY", aliases: ["produced music", "producing music", "worked on music"], parentIds: ["CREATIVE_PRACTICE"] })
    .register({ id: "DRAWING", label: "drawing", kind: "ACTIVITY", aliases: ["draw", "drew", "sketching", "sketched"], parentIds: ["CREATIVE_PRACTICE"] })
