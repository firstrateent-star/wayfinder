...
export function createCoreLifeConceptRegistryV0() {
  return new ConceptRegistry()
    ...
    .register({ id: "WORK_ACTIVITY", label: "work activity", kind: "ACTIVITY", parentIds: ["ACTIVITY"] })
    .register({ id: "FOOD_INTAKE", label: "food intake", kind: "ACTIVITY", aliases: ["ate", "eating"], parentIds: ["ACTIVITY"] })
    .register({ id: "MEAL", label: "meal", kind: "ACTIVITY", aliases: ["breakfast", "lunch", "dinner"], parentIds: ["FOOD_INTAKE"] })
    .register({ id: "EXPENSE", label: "expense", kind: "RESOURCE", aliases: ["spent", "purchase", "paid"] })
    .register({ id: "EMOTIONAL_STATE", label: "emotional state", kind: "STATE", aliases: ["stressed", "calm", "happy", "frustrated", "relieved"] })
    .register({ id: "ENERGY_STATE", label: "energy state", kind: "STATE", aliases: ["tired", "exhausted", "drained", "energized"] })
